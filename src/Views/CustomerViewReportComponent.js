...
import ReportsA from './ReportsA';



export default class CustomerViewReportComponent extends Component {
  render () {
    var myDialog = {
        width: '60%',
        height: '420px',
    ...
    return (
      <div className="box" style={{textAlign: 'center'}}>
        <h2 className="subtitle"><b>Reports</b></h2>
        ...
        <SkyLight dialogStyles={myDialog} hideOnOverlayClicked ref="ReportsA" title="">
         <ReportsA />
       </SkyLight>
      </div>
    )
