...
import OngoingUpdatesA from './OngoingUpdatesA';


export default class CustomerViewOngoingUpdateComponent extends Component {
  render () {
    ...
    return (
      <div>
        <div className="box" style={{textAlign: 'center'}}>
          <h2 className="subtitle"><b>Ongoing Updates</b></h2>
          ...
          <tr>
            ...
            <td>We’ve received many accolades.</td>
            <td>The importance of going green</td>
            <td>2/11/2002</td>
            <td>2/19/2010</td>
            <td><i className="fa fa-chevron-right" onClick={() => this.refs.OpenItemsA.show()} style={{cursor: 'pointer'}}/></td>
          </tr>
          ...
          <SkyLight dialogStyles={myDialog} hideOnOverlayClicked ref="OngoingUpdatesA" title="">
           <OngoingUpdatesA />
         </SkyLight>
