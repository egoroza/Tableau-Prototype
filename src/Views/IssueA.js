...
export default class IssueA extends Component {
	render(){
		return(
			...
			<div>
				...
				This issue was created on <b>January 7, 2017</b> as a <b>complex, external</b> issue.<br />
								...
								<p style={{textAlign: 'center'}}><button className = "button is-warning">Notify Carrol, Sokolowski</button></p>
				<br />
						...
						<div className="tile is-parent is-vertical">
							<div className="tile is-child">
										...
										<tbody>
										 ...
										 <tr>
											 <th>Description</th>
											 <td>Description goes here... blah blah blah</td>
										 </tr>
										</tbody>
									</table>
							</div>
				...
				<div className="column">
						<b>Issue Timeline</b><br />
										...
										<tbody>
										 ...
										 <tr>
											 <th>2/21/2017:</th>
											 <td><code>Sent reports to John Doe.</code> </td>
										 </tr>
										 <tr>
											 <th>1/7/2017:</th>
											 <td><code>Stuff sent to client</code> </td>
										 </tr>
										 <tr>
											 <th>1/7/2017:</th>
